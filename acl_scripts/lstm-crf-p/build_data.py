...
def pre_main():
    ...
    PIO = ['Nolabel', 'age', 'sex', 'datasamplesize', 'condition']
    #for pio in PIO:
    print('Reading files for Participants')
    crowd_labels = glob('../../ebm_nlp_1_00/annotations/aggregated/hierarchical_labels/participants/train/*.ann')
    for fname in crowd_labels: crowd_ids.add(fname_to_pmid(fname))

    test_labels = glob('../../ebm_nlp_1_00/annotations/aggregated/hierarchical_labels/participants/test/gold/*.ann')
